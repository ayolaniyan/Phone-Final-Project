s//Library: use Sketch / Import Library / Add Library / Minim
import ddf.minim.*;
...
void setup () {
  ...
  song1 = minim.loadFile("../FreeWare Music/MusicDownload/Central Cee Let Go.mp3"); //able to pass absolute path, file name & extension, and URL
}//End setup
//
void draw() {}//End draw
//
